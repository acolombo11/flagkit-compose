...
val FlagKit.AZ: ImageVector
    get() {
        if (_AZ != null) {
            return _AZ!!
        }
        _AZ = ImageVector.Builder(
            name = "AZ",
            defaultWidth = 21.dp,
            defaultHeight = 15.dp,
            viewportWidth = 21f,
            ...
            path(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
                        0f to Color(0xFF24AAD5),
                        1f to Color(0xFF1899C2)
                    ),
                    start = Offset(10.5f, 0f),
                    end = Offset(10.5f, 5f)
                ),
            ...
            path(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
                        0f to Color(0xFFED1845),
                        1f to Color(0xFFDE0C39)
                    ),
            ...
            path(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
                        0f to Color(0xFF21BF75),
                        1f to Color(0xFF19AD68)
                    ),
