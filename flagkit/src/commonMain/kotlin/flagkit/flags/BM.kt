...
val FlagKit.BM: ImageVector
    get() {
        if (_BM != null) {
            return _BM!!
        }
        _BM = ImageVector.Builder(
            name = "BM",
            defaultWidth = 21.dp,
            defaultHeight = 15.dp,
            viewportWidth = 21f,
            ...
            path(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
                        0f to Color(0xFFDC1F37),
                        1f to Color(0xFFCF142C)
                    ),
                    start = Offset(10.5f, 0f),
                    end = Offset(10.5f, 15f)
                ),
            ...
            group(
                ...
                path(
                    fill = SolidColor(Color(0xFF65B5D2)),
                    strokeLineWidth = 1f,
                    pathFillType = PathFillType.EvenOdd
                ) {
                    moveTo(15f, 8f)
            ...
            group(
                ...
                path(
                    fill = Brush.linearGradient(
                        colorStops = arrayOf(
                            0f to Color(0xFFE20B0C),
                            1f to Color(0xFFD40001)
                        ),
                        start = Offset(15f, 6f),
                        end = Offset(15f, 8f)
                    ),
            ...
            group(
                ...
                path(
                    fill = SolidColor(Color(0xFF2F8F22)),
                    strokeLineWidth = 1f,
                    pathFillType = PathFillType.EvenOdd
                ) {
                    moveTo(13f, 9f)
