...
val FlagKit.KY: ImageVector
    get() {
        if (_KY != null) {
            return _KY!!
        }
        _KY = ImageVector.Builder(
            name = "KY",
            defaultWidth = 21.dp,
            defaultHeight = 15.dp,
            viewportWidth = 21f,
            ...
            path(
                fill = SolidColor(Color(0xFFFAD051)),
                strokeLineWidth = 1f,
                pathFillType = PathFillType.EvenOdd
            ) {
                moveTo(14f, 4f)
            ...
            group(
                ...
                path(
                    fill = SolidColor(Color(0xFFCF142C)),
                    strokeLineWidth = 1f,
                    pathFillType = PathFillType.EvenOdd
                ) {
                    moveTo(13f, 4f)
            ...
            group(
                ...
                path(
                    fill = Brush.linearGradient(
                        colorStops = arrayOf(
                            0f to Color(0xFF125FBA),
                            1f to Color(0xFF0C50A1)
                        ),
