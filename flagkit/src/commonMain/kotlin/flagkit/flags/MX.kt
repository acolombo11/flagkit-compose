...
val FlagKit.MX: ImageVector
    get() {
        if (_MX != null) {
            return _MX!!
        }
        _MX = ImageVector.Builder(
            name = "MX",
            defaultWidth = 21.dp,
            defaultHeight = 15.dp,
            viewportWidth = 21f,
            ...
            path(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
                        0f to Color(0xFF128A60),
                        1f to Color(0xFF0B6848)
                    ),
            ...
            path(
                fill = SolidColor(Color(0xFF8C9157)),
                strokeLineWidth = 1f
            ) {
                moveTo(8f, 7f)
            ...
            path(
                fill = SolidColor(Color(0xFFC59262)),
                strokeLineWidth = 1f,
                pathFillType = PathFillType.EvenOdd
            ) {
                moveTo(9.5f, 6.5f)
