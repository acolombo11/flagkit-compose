...
val FlagKit.SM: ImageVector
    get() {
        if (_SM != null) {
            return _SM!!
        }
        _SM = ImageVector.Builder(
            name = "SM",
            defaultWidth = 21.dp,
            defaultHeight = 15.dp,
            viewportWidth = 21f,
            ...
            path(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
                        0f to Color(0xFF7CCCF5),
                        1f to Color(0xFF62B7E3)
                    ),
            ...
            path(
                fill = SolidColor(Color(0xFF445F42)),
                strokeLineWidth = 1f
            ) {
                moveTo(8f, 7f)
            ...
            path(
                fill = SolidColor(Color(0xFFD89F3D)),
                strokeLineWidth = 1f,
                pathFillType = PathFillType.EvenOdd
            ) {
                moveTo(9.5f, 6.5f)
